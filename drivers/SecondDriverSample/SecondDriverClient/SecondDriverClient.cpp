...
#include <Windows.h>
#include <stdio.h>
#include "..\SecondDriver\SecondDriverCommon.h"
...
int main(int argc, const char* argv[]) {
	...
	DWORD returned;
	BOOL success = DeviceIoControl(hDevice, IOCTL_SECOND_DRIVER_SET_PRIORITY, &data, sizeof(data), nullptr, 0, &returned, nullptr);
	if (success)
